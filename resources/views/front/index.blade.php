                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $featured->slug) }}"
                                class="font-bold text-4xl leading-[45px] text-white two-lines hover:underline transition-all duration-300">{{ $featured->name }}</a>
                            <p class="text-white">{{ $featured->created_at->format('d M, Y') }} • {{ $featured->category->name }}</p>
                        </div>
                ...
                <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <a href="{{ route('front.details', $business_featured_articles->slug) }}"
                            ...
                            {{ $business_featured_articles->name }}</a>
                ...
                <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                    <div class="flex flex-col gap-[10px]">
                        ...
                        <a href="{{ route('front.details',$automotive_featured_articles->slug) }}"
                            class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">
                            {{ $automotive_featured_articles->name }}</a>
