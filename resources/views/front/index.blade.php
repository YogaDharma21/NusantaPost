                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-[10px]">
                                ...
                                <a href="{{ route('front.details', $featured->slug) }}"
                                    class="font-bold text-4xl leading-[45px] text-white two-lines hover:underline transition-all duration-300">{{ substr($featured->name, 0, 50) }}{{ strlen($featured->name) > 50 ? '...' : '' }}</a>
                                <p class="text-white">{{ $featured->created_at->format('d M, Y') }} •
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    {{ substr($article->category->name, 0, 50) }}{{ strlen($article->category->name) > 50 ? '...' : '' }}
                                </p>
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $business_featured_articles->slug) }}"
                                ...
                                {{ substr($business_featured_articles->name, 0, 50) }}{{ strlen($business_featured_articles->name) > 50 ? '...' : '' }}
                            </a>
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $entertainment_featured_articles->slug) }}"
                                ...
                                {{ substr($entertainment_featured_articles->name, 0, 50) }}{{ strlen($entertainment_featured_articles->name) > 50 ? '...' : '' }}
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $automotive_featured_articles->slug) }}"
                                ...
                                {{ substr($automotive_featured_articles->name, 0, 50) }}{{ strlen($automotive_featured_articles->name) > 50 ? '...' : '' }}
